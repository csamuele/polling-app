...
class QuestionWriteSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        if choices_data is not None:
            ...
            existing_choice_ids = [
                choice.id for choice in instance.choices.all()]
            new_choice_ids = [
                choice['id'] for choice in choices_data if 'id' in choice]
...
class CreateVoteSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        # if Vote.objects.filter(question_id=question.id, owner=user).exists():
        ...
        if len(choice_ids) != len(set(choice_ids)):
            raise serializers.ValidationError(
                "You cannot vote for the same choice twice.")
