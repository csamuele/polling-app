...
export const QuestionForm: React.FC<QuestionFormProps> = ({ open, onClose, onSave, title }) =>  {
                ...
                <form onSubmit={handleSave} className='lg:w-[440px] mx-auto' >
                    ...
                    <div>
                        ...
                        {choices.map((choice, index) => (
                            <div key={index} className="flex items-center justify-between px-4 border rounded-md dark:border-gray-700 border-gray-200 mb-2">
                                <input 
                                    key={index}
                                    type="text" 
                                    placeholder="Choice" 
                                ...
                                />
                                <button type="button" onClick={() => handleDeleteChoice(index)} className="text-red-500">
